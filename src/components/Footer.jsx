...
const Footer = () => {
  ...
  <nav>
   ...
   <div className="flex items-center ">
    ...
    <p> <span className='text-lg font-medium'>Your journey, your choice.</span><br /> 
...
<div className="flex flex-col bg-gray-500 font-medium items-center pb-6">
                <hr className="border-t-2 border-gray-700 w-[90%] mx-auto" />
                <footer className="footer footer-center  p-0 mt-4 text-base-content">
                    <aside >
